 ...
 */
export const getPendingVerification = asyncHandler(
...
export const getMyPaymentHistory = asyncHandler(
  async (req: Request, res: Response, _next: NextFunction) => {
    if (!req.user)
      throw new AppError('Unauthenticated', HTTP_STATUS.UNAUTHORIZED, ERROR_CODES.UNAUTHORIZED);
 ...
 */
export const uploadQrCode = asyncHandler(
  async (req: Request, res: Response, _next: NextFunction) => {
    if (!req.user)
      throw new AppError('Unauthenticated', HTTP_STATUS.UNAUTHORIZED, ERROR_CODES.UNAUTHORIZED);
 ...
 */
export const getActiveQrCodes = asyncHandler(
  async (_req: Request, res: Response, _next: NextFunction) => {
 ...
 */
export const getAllQrCodes = asyncHandler(
  async (_req: Request, res: Response, _next: NextFunction) => {
 ...
 */
export const toggleQrCode = asyncHandler(
  async (req: Request, res: Response, _next: NextFunction) => {
 ...
 */
export const deleteQrCode = asyncHandler(
  async (req: Request, res: Response, _next: NextFunction) => {
    const qr = await PaymentQrCodeModel.findById(parseInt(req.params.id, 10));
    if (!qr) throw new AppError('QR code not found', HTTP_STATUS.NOT_FOUND, ERROR_CODES.NOT_FOUND);
